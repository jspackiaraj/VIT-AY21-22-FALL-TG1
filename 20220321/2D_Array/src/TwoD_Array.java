public class TwoD_Array {
    public static void main(String[] args) {
        ...
        // We can also have strings in arrays.
        String strArr [][]  = {{"Hello", "World"}, {"Java is ", "Fun"}};
        int intCntI = 0;
        int intCntJ = 0;
        ...
        // The array of string is printed here
        intCntI = 0;
        intCntJ = 0;
        for(intCntI = 0; intCntI < 2; intCntI++){
            for(intCntJ = 0; intCntJ < 2; intCntJ++){
                System.out.print(strArr[intCntI][intCntJ] + "\t\t");
            }
            System.out.println("");
        }
    }
